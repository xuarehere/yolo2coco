...
parser.add_argument('--random_split', action='store_true', help="random split the dataset, default ratio is 6:2:2")
...
def yolo2coco(arg):
    ...
    for k, index in enumerate(tqdm(indexes)):
        ...
        txtFile = index.replace('images','txt').replace('.jpg','.txt').replace('.jpeg','.txt').replace('.png','.txt')
        # 读取图像的宽和高
